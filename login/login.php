...
<!-- login -->
	<div class="login">
		<div class="container">
			...
			<p><a href="../registrasi/register.php">Registrasi Disini</a> (atau) kembali ke <a href="../index.php">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
