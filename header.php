						...
						<?php	
										...
										if(isset($_SESSION['member'])) {
											...
											$jumlah_cart = mysql_num_rows($jum);
												 ...
												 echo "
														<button class='w3view-cart' type='submit' name='submit' value=''><i class='fa fa-cart-arrow-down' aria-hidden='true'>($jumlah_cart)</i>";
										}
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php"><img src="images/head.png" width="355" height="70" style="padding-left: 2px ;"></a></h1>
			</div>
		<div class="w3l_search">
			<form action="produk.php" method="post">
				<input type="search" name="cari" placeholder="Cari Produk . . . " required="">
				<button type="submit" name="btn_cari" class="btn btn-default search" aria-label="Left Align">
