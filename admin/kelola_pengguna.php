      ...
      function update(){ // ini akan mengarah ke function ubah()
            ...
            if(isset($_POST['btn_simpan'])){
                        ...
                        $email=$_POST['txtEmail'];
                          ...
                          $sql_update = "UPDATE member SET ".$update." WHERE id=".$id."";



                          $exe = mysql_query($sql_update);

                          echo "<script language='javascript'> alert ('Member berhasil di Update ....'); document.location='kelola_pengguna.php'; </script>";
                      }
        ...
        function ubah(){
                    ...
                    if(isset($_GET['id'])){
                        ...
                        $sql_ubah = "SELECT id, nama, alamat, nomor_handphone, email FROM member WHERE id=".$id ;
                ...
                <div class="form-two widget-shadow">
                    ...
                    <div class="form-body" data-example-id="simple-form-inline">
                        <form action="kelola_pengguna.php?aksi=update&id=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
                          <fieldset>
          ...
          <div class="tables">
                ...
                <div class="table-responsive bs-example widget-shadow">
                  <div class = "colmd-2">
                          ...
                          <a class='btn btn-warning btn-xs hvr-icon-float-away ' href='kelola_pengguna.php?aksi=tambah'><i class='fa fa-trash'></i> Tambah Data </a></h2> 
                      </div>
            <table class="table table-bordered table-hover"> 
              ...
              <?php 
                  ...
                  $sql=mysql_query("select id, nama, alamat, nomor_handphone, email from member limit ".$limit_start.",".$limit);
              ...
              <tbody> 
                <tr> 
                  ...
                  <td style="text-align: center;">
                      <a class='btn btn-primary btn-xs' href='kelola_pengguna.php?aksi=ubah&id=<?php echo $id;?>'><i class='fa fa-cogs'></i> Edit</a>
                      <a class='btn btn-danger btn-xs' href='kelola_pengguna.php?aksi=hapus&id=<?php echo $id;?>'><i class='fa fa-trash'></i> Hapus</a>
                  </td> 
                </tr> 
            ...
            <div class="col-md-5" style="" >
              <ul class="pagination" style="margin-left: 90px">
                ...
                $sql2 =("SELECT COUNT(*) AS jumlah FROM member");
                ...
                ?>
                  <li<?php echo $link_active; ?>><a href="kelola_pengguna.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                <?php
                }
                ?>
                ...
                ?>
                  <li><a href="kelola_pengguna.php?page=<?php echo $link_next; ?>">></a></li>
                  <li><a href="kelola_pengguna.php?page=<?php echo $jumlah_page; ?>">>></a></li>
                <?php
                }
                ?>
              </ul>
