		...
		<ul id="demo1">
			<li>
				...
				<div class="slide-desc">
					<h3>Dapatkan Harga Terbaik Buku Anda Hanya Di Sini</h3>
				</div>
			</li>
			<li>
				<img src="images/bg_2.jpg" alt="" />
				  <div class="slide-desc">
					<h3>Temukan Buku Menarik Yang Anda Cari</h3>
				</div>
			</li>
			...
			<li>
				...
				<div class="slide-desc">
					<h3>Jelajahi Pustaka Buku-Buku Yang Tersedia</h3>
				</div>
			</li>
		</ul>
	<!-- //main-slider -->
